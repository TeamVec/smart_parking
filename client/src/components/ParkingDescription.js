      ...
      <div>
        ...
        <div
          ...
          style={{
            ...
            backgroundImage:
              'url("https://www.transparenttextures.com/patterns/green-gobbler.png")',
            height: "91vh",
            width: "100%",
          }}
        >
          <div className="ui grid">
            <div className="seven wide column">
              <div style={{ width: "100%" }} className="ui card">
                <div className="content">
                  ...
                  <h4>{`Car Fare :  ${
                    this.state.parking.fare_car == null
                      ? "Not Available"
                ...
                <div className="content">
                  ...
                  <img
                    ...
                    src="https://d2uqqhmijd5j2z.cloudfront.net/files/44237/gallery/44237.jpeg"
                    alt=""
                  ></img>
                ...
                <div className="extra button">
                  <Link to={`/bookingDetails/${id}`}>
                    <button className="ui primary button">BOOK NOW</button>
                  </Link>
                </div>
              </div>
            </div>
            <div className="nine wide column">
              <Map
                latitude={this.state.parking.latitude}
                longitude={this.state.parking.longitude}
                name={this.state.parking.p_name}
              />
            </div>
          </div>
        </div>
